...
const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    //Variable for cursor position with different speed
  ...
  // useEffect(() => {
  //   // ✅ Mobile check moved inside effect (Rules of Hooks fix)
  ...
  //   // ✅ Cleanup to prevent listener leaks
  //   return () => {
