  ...
  return (
    ...
    >
      ...
      <ScrollStack useWindowScroll={true}>
        ...
        <ScrollStackItem itemClassName="bg-[#111111] border border-white/5 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl relative overflow-hidden group min-h-fit mb-4">
          ...
          <div className="relative z-10 flex flex-col h-full gap-4 sm:gap-5">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
              <div>
                <p className="font-grotesk font-bold text-sm sm:text-lg lg:text-xl text-blue-400/80">
                  Ateneo Innovation Center
                </p>
                <h2 className="font-grotesk text-xl sm:text-3xl lg:text-4xl font-bold text-[#fafafa] tracking-tight mt-0.5">
                  Research & Development Intern
                </h2>
              </div>
              <span className="font-mono inline-flex items-center w-fit px-3 py-1 rounded-full border border-white-500/20 bg-blue-500/10 text-[10px] sm:text-xs font-medium text-slate-300 uppercase tracking-widest shrink-0">
                Jan — April 2026
              </span>
            </div>
            ...
            <div className="flex flex-col gap-6 mt-auto">
              <div>
                <p className="font-mono text-[9px] font-medium text-white/30 uppercase tracking-widest mb-2">
                  Technologies
                </p>
                <div className="flex flex-wrap gap-1.5">
                  {["Python", "Arduino", "ESP32", "R-Pi"].map((tech) => (
                    <span
                      key={tech}
                      className="font-mono px-2 py-1 rounded-md bg-white/[0.03] border border-white/[0.08] text-[10px] sm:text-xs text-white/50"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          w-full sm:w-fit rounded-xl border border-blue-500/20 bg-blue-500/5 
          text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase text-blue-400
